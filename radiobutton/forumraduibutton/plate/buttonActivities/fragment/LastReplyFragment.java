...
public class LastReplyFragment extends BaseShihuhuFragment {

    public LastReplyFragment(LinkedList<Map<String, String>> lists, ViewPager viewPager, SQLiteDatabase db) {
